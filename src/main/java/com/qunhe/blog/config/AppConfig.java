...
import com.qunhe.blog.jersey.CmsResourceConfigCustomizer;
import com.qunhe.blog.jpa.DefaultJpaRepository;
...
@EnableJpaAuditing
@EnableAsync
@EntityScan("com.qunhe.blog.**.model")
@EnableTransactionManagement
@EnableConfigurationProperties(AppProperties.class)
@SpringBootApplication(scanBasePackages = { "com.qunhe.blog" })
@EnableJpaRepositories(basePackages = { "com.qunhe.blog.**.dao" }, repositoryBaseClass = DefaultJpaRepository.class)
